...
RSpec.describe "Questions", type: :request do
  ...
  describe "POST /questions" do
    context "with valid text" do
      it "returns 200" do
        post "/questions", params: { text: "can a creature with flying be blocked" }, as: :json
      ...
      it "passes the text to CompRulesEmbedding.search" do
        ...
        post "/questions", params: { text: "flying rules" }, as: :json
      end

      it "includes section_number, title, and content in each source" do
        post "/questions", params: { text: "flying" }, as: :json
      ...
      it "persists the question to the database" do
        expect { post "/questions", params: { text: "can a creature with flying be blocked" }, as: :json }
    ...
    context "with blank text" do
      it "returns 422" do
        post "/questions", params: { text: "" }, as: :json
        expect(response).to have_http_status(:unprocessable_content)
      end
    end
